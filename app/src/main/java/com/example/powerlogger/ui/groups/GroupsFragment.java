...
public class GroupsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        groupsArrayList.add(new Group("aoihudsa-asdoihasdno-adskjndasjk", "Group 1"));
        groupsArrayList.add(new Group("aoihudsaa-asdoi2hasdnao-adskj2ndasjk", "Group 2"));
        groupsArrayList.add(new Group("aoishudsa-asdoihdasdno-adskjnd2sasjk", "Group 3"));
        groupsArrayList.add(new Group("aoihu22dsa-asdo2ihasddno-adsakjndasjk", "Group 4"));
        ArrayList <String> stringArrayList = new ArrayList<>();

        for(Group g : groupsArrayList) {
            stringArrayList.add(g.getName());
        }
