...
import com.eduardv.powerlogger.databinding.UnitsFragmentBindingImpl;
...
public class UnitsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        } else if (settingsDTO.getHeightUnit() == HeightUnit.FEET) {
            binding.feetButton.setChecked(true);
        } else {
            binding.inchesButton.setChecked(true);
        }
    ...
    private void onHeightCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            ...
            case R.id.feetButton:
                viewModel.getDto().setHeightUnit(HeightUnit.FEET);
                break;
            case R.id.inchesButton:
